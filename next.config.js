...
module.exports = withCSS(withSass({
  webpack(config) {
    config.plugins.push(new webpack.DefinePlugin({
      ...
      'process.env.ALGOLIA_PLACES_API_KEY': JSON.stringify(process.env.ALGOLIA_PLACES_API_KEY),
      'process.env.ALGOLIA_APPLICATION_ID': JSON.stringify(process.env.ALGOLIA_APPLICATION_ID),
    }));
